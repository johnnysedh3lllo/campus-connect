...
// COMPONENTS
import Notifications from "@/app/(main-app)/(in-app)/settings/notifications";
import Security from "@/app/(main-app)/(in-app)/settings/security";
import Support from "@/app/(main-app)/(in-app)/settings/support";
...
export function SettingsPageBody({
  ...
  const tabs: Tab[] = [
    ...
    { id: 2, title: "Notifications", component: <Notifications initialSettings={initialSettings} /> },
